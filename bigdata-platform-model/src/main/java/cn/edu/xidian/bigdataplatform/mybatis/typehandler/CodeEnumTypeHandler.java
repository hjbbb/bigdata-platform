...
import cn.edu.xidian.bigdataplatform.mybatis.entity.usersource.SourceType;
import cn.edu.xidian.bigdataplatform.mybatis.utils.CodeEnumUtil;
...
// 有其它的枚举类需要转换就在SourceType.class后面添加
@MappedTypes({BaseCodeEnum.class, SourceType.class})
